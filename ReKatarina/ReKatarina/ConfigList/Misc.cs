...
namespace ReKatarina.ConfigList
{
    public static class Misc
    {
        ...
        static Misc()
        {
            ...
            _Delay = Menu.Add("Delay", new Slider("Select your delay between spells in (ms).", 1, 0, 9));
            _MaxRandomDelay = Menu.Add("MaxRandomDelay", new Slider("Additional random delay in (ms).", 1, 0, 9));
        }
